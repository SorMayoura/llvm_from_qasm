source_filename = "error_correctiond3_n5.qasm"
target datalayout = ""
target triple = ""
...
%22 = measure q1* %21, i1* %c2;measure q[2] -> c[2];
%22 = measure q1* %21, i1* %c3;measure q[3] -> c[3];
%22 = measure q1* %21, i1* %c4;measure q[4] -> c[4];
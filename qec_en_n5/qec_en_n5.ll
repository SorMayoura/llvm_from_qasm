source_filename = 'qec_en_n5.qasm'
target datalayout = ''
target triple = ''
...
%q02 = measure q1* %q01, i1* %c0  ;measure q[2] -> c[2];
%q12 = measure q1* %q11, i1* %c1  ;measure q[4] -> c[4];
%q2R = measure q1* %q2Q, i1* %c2  ;measure q[0] -> c[0];
%q32 = measure q1* %q31, i1* %c3  ;measure q[1] -> c[1];
%q42 = measure q1* %q41, i1* %c4  ;measure q[3] -> c[3];